...
MAKE_SYSTEM_PROP(ACTIVITY,UIDopeNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIDopeNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIDopeNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIDopeNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIDopeNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIDopeNativeItemContactAdd);

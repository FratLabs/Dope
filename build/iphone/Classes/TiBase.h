...
// in simulator we redefine to format for Dope Developer console
...
{\
	NSString * exceptionName = [@"org.dope." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dope";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIDopeNativeItemNone = -1, 
	UIDopeNativeItemSpinner = -2,
	UIDopeNativeItemProgressBar = -3,
	
	UIDopeNativeItemSlider = -4,
	UIDopeNativeItemSwitch = -5,
	UIDopeNativeItemMultiButton = -6,
	UIDopeNativeItemSegmented = -7,
	
	UIDopeNativeItemTextView = -8,
	UIDopeNativeItemTextField = -9,
	UIDopeNativeItemSearchBar = -10,
	
	UIDopeNativeItemPicker = -11,
	UIDopeNativeItemDatePicker = -12,
	
	UIDopeNativeItemInfoLight = -13,
	UIDopeNativeItemInfoDark = -14,
	
	UIDopeNativeItemDisclosure = -15,
	
	UIDopeNativeItemContactAdd = -16
};

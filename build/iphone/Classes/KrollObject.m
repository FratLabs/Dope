 ...
 * Copyright (c) 2009-2011 by Dope, Inc. All Rights Reserved.
...
//@interface DopeObject : NSObject
//@end

@interface DopeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DopeObject class]])
		{
			for (NSString *key in [[(DopeObject*)o modules] allKeys])
			{
